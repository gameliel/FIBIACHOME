						...
						<div class="col-lg-6 col-md-6">
							<div class="cn-info">
								<ul>
									...
									<li><i class="ti-email"></i>Info@fibiachomes.com</li>
								</ul>
							</div>
						</div>
						<div class="col-lg-6 col-md-6">
			...
			<div class="header header-light nav-left-side">
				<nav class="headnavbar">
					<div class="nav-header">
							<a href="{{ url('/')}}" class="brand"><h2>F<span style="Color:#53b772;">I</span>BIAC</h2></a>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="footer-widget">
            <h4 class="widget-title">About fibiachomes</h4>
            <p>fibiachomes features homes for sale in all states. fibiachomes online search portal of property listings gives you the ability to refine your search criteria by different factors, including geographical location.</p>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="footer-widget">
            ...
            <ul class="footer-bottom-social">
              <li><a href="https://web.facebook.com/fibiachomess-102484724693780/"><i class="ti-facebook"></i></a></li>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-12 col-md-12 text-center">
          <p class="mb-0">© 2019 fibiachomes. Designd By <a href="#">Simvic</a> All Rights Reserved</p>
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
    <div class="modal-content" id="sign-up">
      ...
      <div class="modal-body">
        ...
        <div class="social-login mb-3">
          <ul>
            <li><a href="https://web.facebook.com/fibiachomess-102484724693780/" class="btn connect-fb"><i class="ti-facebook"></i>Facebook</a></li>
            <li><a href="#" class="btn connect-twitter"><i class="ti-twitter"></i>Twitter</a></li>
          </ul>
        </div>
        <div class="text-center">
